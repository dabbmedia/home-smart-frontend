...
-- CREATE ROLE home_smart LOGIN;
-- or
CREATE USER home_smart WITH PASSWORD 'home_smart';

CREATE DATABASE home_smart encoding UTF8 LC_COLLATE 'en_US.utf8' LC_CTYPE 'en_US.utf8' OWNER home_smart template template0;
CREATE SCHEMA home_smart;

GRANT CONNECT ON DATABASE home_smart TO home_smart;
GRANT USAGE ON SCHEMA public TO home_smart;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO home_smart;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO home_smart;
